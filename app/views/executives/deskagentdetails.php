        ...
        <div class="col-md-8 offset-md-2">
          <div class="card">
            <div class="card-header">
              <h3>Desk Agent Registration</h3>
            </div>
            <div class="card-body">
              <div class="form">
                <h4>Personal Details</h4>
                <form action="<?php echo URLROOT; ?>executives/deskagentdetails" method="post">
                  <div class="row">
              ...
              <div class="d-grid gap-2 col-6 mx-auto my-5">
                <button class="btn btn-primary" type="submit" id="submitdeskagentDetails" name="submitdeskagentDetails">Submit</button>
              </div>
              </form>
            </div>
          </div>

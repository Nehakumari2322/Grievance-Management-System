        ...
        <div class="col-md-8 offset-md-2">
          <div class="card">
            <div class="card-header">
              <h3>Update Field Agent Details</h3>
            </div>
            <div class="card-body">
              <div class="form">
                <h4>Personal Details</h4>
                <form action="<?php echo URLROOT; ?>executives/updateFieldAgentDetails" method="post">
                <input type="hidden" name="<?php echo 'field_agent_id';?>" id="<?php echo 'field_agent_id';?>"  value="<?php echo $data->field_agent_id;?>">
              ...
              <div class="d-grid gap-2 col-6 mx-auto my-5">
                <button class="btn btn-primary" type="submit" id="updatefieldagentdetails" name="updatefieldagentdetails">Submit</button>
              </div>
              </form>
            </div>
          </div>

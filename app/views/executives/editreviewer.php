        ...
        <div class="col-md-8 offset-md-2">
          <div class="card">
            <div class="card-header">
              <h3>Edit Reviewer Form</h3>
            </div>
            <div class="card-body">
              <div class="form">
                <h4>Personal Details</h4>
                <form action="<?php echo URLROOT; ?>executives/updatereviewerdetails" method="post">
                <input type="hidden" name="<?php echo 'reviewer_id';?>" value="<?php echo $data->reviewer_id;?>"><?php echo $data->reviewer_id;?>
                  ...
                  <div class="row">
                    <div class="mb-3 col-sm-6">
                      ...
                      <input
                        ...
                        id="agent_name" name="reviewer_name" value="<?php echo $data->reviewer_name;?>"
              ...
              <div class="form">
                ...
                <!-- <form> -->
                  ...
                  <div class="mb-3 col-sm-12">
                      ...
                      <textarea
                        class="form-control"
                        id="office_address" name="office_address" value="<?php echo $data->office_address;?>"
                        rows="3"
              ...
              <div class="d-grid gap-2 col-6 mx-auto my-5">
                <button class="btn btn-primary" type="submit" id="updatereviewerdetails" name="updatereviewerdetails">Submit</button>
              </div>
              </form>
            </div>
          </div>

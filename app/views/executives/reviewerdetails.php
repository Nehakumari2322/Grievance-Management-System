        ...
        <div class="col-md-8 offset-md-2">
          <div class="card">
            <div class="card-header">
              <h3>Reviewer Registration Form</h3>
            </div>
            <div class="card-body">
              <div class="form">
                <h4>Personal Details</h4>
                <form action="<?php echo URLROOT; ?>executives/reviewerDetails" method="post">
                  <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                    <!-- <input type="hidden" value="<?php echo $count;?>" name="totalcount" id="totalcount">  <?php echo $count;?>          -->
                    <!-- <input type="hidden" name="user_id" value="<?php echo $moreData['user_id']?>"> -->
              ...
              <div class="d-grid gap-2 col-6 mx-auto my-5">
                <button class="btn btn-primary" type="submit" id="submitreviewerdetails" name="submitreviewerdetails">Submit</button>
              </div>
              </form>
            </div>
          </div>

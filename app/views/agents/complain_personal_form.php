...
<?php if($newData['message'] == 'CaseRegistered'){ ?>
        ...
        <form action="<?php echo URLROOT; ?>agents/complainpersonaldetail" method="post">
...
<form action="<?php echo URLROOT; ?>agents/complainpersonaldetail" method="post" enctype="multipart/form-data">
            ...
            <div class="card" style="box-shadow: 0px 8px 32px 0px rgb(104, 149, 210);">  
                ...
                <div class="card-body">   
                    <div class="row g-3 px-5">
                        <div class="col-md-6">
                        <label for="inputAddress" class="form-label">Type of Complains</label><span class="required-field"></span>
                        ...
                        <div class="col-md-6">
                            <label for="inputAddress" class="form-label">Personal/Social Complains</label><span class="required-field"></span>

...
<div class="container-fluid small">
  ...
  <div class="font-weight-bold h2 text-center mt-4">Agent</div>
  <form action="<?php echo URLROOT; ?>agents/agentsaccess" method="post">
...
<form action="<?php echo URLROOT; ?>agents/listofsubcategory" method="post">       
